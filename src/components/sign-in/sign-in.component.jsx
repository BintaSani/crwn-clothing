...
import { SignInContainer, SignInTitle, ButtonsBarContainer, CheckBox, Label } from './sign-in.styles';



const SignIn = ({emailSignInStart, googleSignInStart, managementHidden}) => {
